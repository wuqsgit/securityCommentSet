                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="center">
                            ...
                            <div id="leftdiv" class="row">
                                <div class="col-xs-8">
                                    <div style="background-color: rgba(102,175,233,.1);  border-radius: 10px 10px 10px 10px !important;margin-top: 30px;padding-left: 30px";>
                                ...
                                <div class="col-xs-4" style="margin-top: 30px">
                                  <div class="row">
                                      <div class="col-xs-12">
                                             ...
                                             <div  style="width:99.5%;height:70px;padding-top: 0px" >
                                                 <img src="img/4.png" width="670" height="89" alt="">
                                                 <span style="position:absolute;left:10%;top: 5px"><font color="#fdf5e6" style="font-size: 20px">全国监控设备数：</font></span>
                                                 <span style="position:absolute;left:40%;"><font id="carNum" size="20"  color="#fdf5e6"></font></span>
                                             </div>
                                      </div>
                                  </div>
                                    <div class="row" style="border: 0px">
                                        <div class="col-xs-12"  style="border: 0px;">
                                           <div  id="piediv" style="background-color: rgba(102,175,233,0.1);  border-radius: 10px 10px 10px 10px !important;padding-left: 15%">
                                               <div id="pie" style="width: 400px ;height: 350px;padding: 10px"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <div id="lindiv" style="background-color: rgba(102,175,233,0.1);  border-radius: 10px 10px 10px 10px !important;padding-left: 15%;">
                                            <div id="line" style="width: 400px ;height: 320px;padding-top: 30px" ></div>
                                            </div>
                                        </div>
                                    </div>
...
<script type="application/javascript">
    jQuery(function($) {
        ...
        var heightcenter=height-78;
        $(".page-content").height(heightcenter);
        $("#map").height(heightcenter-60);
      //  var mapwidth=$("#leftdiv").css(width)
       // alert(mapwidth);
        //$("#map").height(mapwidth-60);
        $("#piediv").height((heightcenter-120)/2-30);
        $("#lindiv").height((heightcenter-120)/2-30);
