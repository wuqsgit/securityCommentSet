                ...
                <table style=" height: 90px;font-family: 'Microsoft YaHei';font-size: 12px;vertical-align:middle;min-width: 800px;margin: auto;margin-bottom: 5px"
                  ...
                  <tr>
                    <td>
                      ...
                      出厂编号：<input  id="search_serNum"
                                   name="search_serNum" type="text" maxlength="64"style="width: 200px">
                  ...
                  <tr>
                    <td>
                      ...
                      操作人：<input id="search_usename"
                                  name="search_usename" type="text" maxlength="64">
                      <a style="padding-left: 11px"></a>
          ...
          <div class="col-xs-12" style="padding-left: 0px;padding-right: 0px">
            <table id="simple-table" class="table  table-bordered table-hover">
              ...
              <div style="border: 1px solid #ddd;height: 40px;background-color:#f1f1f5;padding-top: 4px;border-bottom: 0px">
                <label style="padding: 6px;font-size: 12px">&nbsp;使用记录列表</label>
...
<div class="row" id="addForm" style="display: none;margin: 20px;">
  ...
  <div class="text" style="text-align: left;height: 30px;padding-top: 0px;padding-left: 20px">
    ...
    <span id="label_startTime" style="font-weight: bolder;color: #021525;font-family: '微软雅黑', 'Microsoft YaHei', serif">
    </span>
    </span>
    <span style="font-weight: bolder;color: #0b6cbc;font-family: '微软雅黑', 'Microsoft YaHei', serif;padding-left: 50px">
      设备总数：
    ...
    <%--<span  style="font-weight: bolder;color: #0b6cbc;font-family: '微软雅黑', 'Microsoft YaHei', serif;padding-left: 50px">--%>
     <%--关柜时间：--%>
    <%--</span>--%>
    <%--<span id="label_endTime" style="font-weight: bolder;color: #021525;font-family: '微软雅黑', 'Microsoft YaHei', serif">--%>
    </span>
  </div>
  <row>
    <div class="col-xs-12">
...
<script type="text/javascript">
  jQuery(function ($) {
        ...
        success: function (result) {
          ...
          for (var a = 0; a < applicationList.length; a++) {
            ...
            applicationHtml +=
                    ...
                    "<td>" + page + "</td> " +
                    "<td style='text-align: center'>" + convertNull(applicationList[a].usename) + "</td> " +
                    "<td style='text-align: center'>" + convertNull(applicationList[a].equipment) + "</td> " +
                    "<td style='text-align: center'>" + convertNull(applicationList[a].seIp) + "</td> " +
                    "<td style='text-align: center'>" + convertNull(applicationList[a].timeStart) + "</td> " +
                    "<td style='text-align: center;color: #2283C5;'> " +
                    "<span>" +
                    "<a style='cursor:pointer;text-decoration:none' class='productDetail' value='" + id + "'  equipment='"+ applicationList[a].equipment +"' usename='"+ applicationList[a].usename +"' timeStart='"+ applicationList[a].timeStart +"'> 查看详情 </a> " +
                    "</span>" +
                    "</td> " +
                    "</tr>"
          }
    ...
    $(document).on("click", ".productDetail", function (){
      ...
      var timeStart = this.getAttribute("timeStart");
      eidt("查看详情",id, equipment, usenameValue, timeStart);
    })

    function eidt(title,id,equipment, usenameValue, timeStart) {
      var id=id;
        var equipment = equipment;
        var usenameValue = usenameValue;
        var timeStart = timeStart;
      productUpdate(id,title,equipment, usenameValue, timeStart);
    }
    function productUpdate(id,title,equipment, usenameValue, timeStart) {
      var searchUser=null;
      var paramEntity={};
      ...
      $.ajax({
        ...
        success: function (result) {
          ...
          /*if(applicationList.length > 0){
              ...
              $("#label_startTime").html(applicationList[0].timeStart);
          }*/
          var equipmentStr = '';
          if(equipment != 'null' && equipment != null){
              equipmentStr = equipment;
          }
            $("#label_equipment").html(equipmentStr);
            $("#label_usename").html(usenameValue);
            $("#label_startTime").html(timeStart);
...
//                    $("#label_usename").html(applicationList[0].usename);
//                    $("#label_startTime").html(applicationList[0].timeStart);
//                    $("#label_endTime").html(applicationList[0].timeEnd);
//                  }
//
//                  $("#mijianTable").empty();
//
