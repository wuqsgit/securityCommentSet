                                ...
                                <table style=" height: 120px;font-family: 'Microsoft YaHei';font-size: 12px;vertical-align:middle;margin: auto;"
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            出厂编号：<input  id="search_serNum"
                                                         name="search_serNum" type="text" maxlength="12">
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            RFID编号：<input id="search_rfidCode"
                                                          name="search_rfidCode" type="text" maxlength="12">
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <a style="padding-left: 54px"></a> 是否发标签：<select style="width: 163px" id="search_isReadCard" name="search_isReadCard" type="text" maxlength="64" >
                                            <option></option>
                                            <option>是</option>
                                            <option>否</option>
                                        </select>
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    for (var i = 0; i < productList.length; i++) {
                        ...
                        if(productList[i].productId!=null&&productList[i].productId==productList[i].id){
                            var id=productList[i].id;
                            var rfidCode="";
                            if(productList[i].rfidCode!=null){
                                rfidCode=productList[i].rfidCode;
                            }
                            var status=getStatus(productList[i].status);
                            var ckid="ckid"+id;
                            productHtml =
                                "<tr type='0'> " +
                                "<td class='center'>" +
...
//                                "<td>" + page + "</td> " +
                                ...
                                "<td>" + productList[i].locationInfo + "</td> " +
                            ...
                            {
                                if(productList[j].productId!=null&&productList[j].productId==id&&productList[j].productId!=productList[j].id)
                                {
                                    ismijian++;
                            ...
                            if(mijianList.length!=0){
                                ...
                                $.each(mijianList,function (index,item) {
                                    ...
                                    var mijistatus=getStatus(item.status);
                                    var rfidCode="";
                                    ...
                                    productHtml += "<tr style='height: 30px' type='2'>"+
                                        ...
                                        "<td style='padding-left: 40px'>密品状态："+ mijistatus+"</td>" +
